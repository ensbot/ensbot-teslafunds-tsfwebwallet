...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different ETIG node (e.g. `ETIG (Etherscan.io)` or `ETIG (Infura.io)` or `ETIG (MyEtherWallet)`) and check again.',
...
GEN_Help_12                 : 'Use it to unlock your wallet via EthereumTiger Wallet (or Mist, Geth, Parity and other wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending ETIG = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ETIG here](www.wallet.etig.europool.me/helpers.html)',
...
sidebar_donation            : 'EthereumTiger Wallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
sidebar_donate              : 'تبرع ',
sidebar_thanks              : 'شكرا!!! ',
...
ADD_Ledger_0a               : 'You must access EthereumTiger Wallet via a secure(SSL / HTTPS) connection to connect.',
ADD_Ledger_0b               : 'Re-open EthereumTiger Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'If you want to use this wallet with your EthereumTiger Wallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'A standard transaction using 21000 gas will cost 0.000441 ETH. We use a slightly-above-minimum gas price of 0.000000021 ETIG to ensure it gets mined quickly. We do not take a transaction fee. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via MyEtherWallet. You can [download the EthereumTiger Wallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et de ré-imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/). ',
...
ADD_Ledger_0a               : 'Réouvrir EthereumTiger Wallet sur une connexion sécurisée (SSL) ',
ADD_Ledger_0b               : 'Réouvrir EthereumTiger Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Connexion au TREZOR ',
ADD_Trezor_select           : 'Ceci est une _seed_ TREZOR ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Réouvrir EthereumTiger Wallet sur une connexion sécurisée (SSL) ',
ADD_DigitalBitbox_0b        : 'Réouvrir EthereumTiger Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
TranslatorName_1            : '[bstashio](www.wallet.etig.europool.me/?gaslimit=21000&to=0xD8FE791535Ad85D2b0E76e603443C1b39107729F&value=1.0#send-transaction) · ',
...
HELP_4_Desc_2               : 'Navigate to the "Send EthereumTiger & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send EthereumTiger & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send EthereumTiger & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Send EthereumTiger & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Send EthereumTiger & Tokens" page offline? ',
