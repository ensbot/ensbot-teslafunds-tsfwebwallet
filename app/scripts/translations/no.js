...
tx_notFound_4               : 'Bruk rullegardinmenyen øverst til høyre og velg en annen ETH-node. (f.eks. `ETIG (Etherscan.io)` eller `ETIG (Infura.io)` eller `ETIG (MyEtherWallet)`), og sjekk igjen.',
...
tx_FoundOnChain_3           : '**Hvis du ikke ser noen feil, var transaksjonen vellykket.** Dine ETIG eller Tokens er der du sendte dem. Hvis du ikke ser disse ETIG eller Tokens der du sendte dem, og det har gått mer enn 24 timer, vennligst [kontakt vedkommende service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send dem en *lenke* til transaksjonen din og spør dem pent om å se på situasjonen din.',
...
GEN_Help_12                 : 'Bruk den sammen med passordet du oppga til å låse opp lommeboken din via EthereumTiger Wallet (eller Mist, Geth, Parity og andre lommebok-klienter.) ',
...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> ETIG her](www.wallet.etig.europool.me/helpers.html)',
...
NAV_SendEther               : 'Send EthereumTiger & Tokens ',
...
ADD_Ledger_0a               : 'Åpne EthereumTiger Wallet på nytt på en sikker (SSL) forbindelse. ',
ADD_Ledger_0b               : 'Åpne EthereumTiger Wallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Åpne EthereumTiger Wallet på nytt på en sikker (SSL) forbindelse. ',
ADD_DigitalBitbox_0b        : 'Åpne EthereumTiger Wallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'En standard transaksjon som bruker 21000 gas vil koste 0,000441 ETH. Vi bruker en litt-over-minimum gas-pris på 0,000000021 ETIG for å sikre at transaksjonen blir raskt behandlet. Vi tar ikke noe transaksjonsgebyr. ',
...
TRANSModal_Content_1        : '**ETIG (Standardtransaksjon): ** Dette Oppretter en standardtransaksjon direkte fra en adresse ti en annen. Den har standard gas på 21000. Det er sannsynlig at ETIG som sendes med denne metoden også vil bli sendt som ETC på ETC-kjeden (hvis kontoen inneholder både ETIG og ETC). Dette er anbefalt metode hvis kontoen kun inneholder ETH. ',
...
SWAP_init_2                 : " med ", // "I want to swap my X ETIG for X BTC"
...
SWAP_progress_3             : "Mottatt! ", // ETIG Received!
...
SWAP_unlock                 : "Lås opp din lommebok for å sende ETIG eller Tokens direkte fra denne siden. ",
...
ERROR_28                    : '**Du trenger din Keystore-fil & passord eller din private nøkkel** for å få tilgang til denne lommeboken i framtiden. Vennligst lagre og sikkerhetskopier den eksternt! Det finnes ingen måte å gjenopprette en lommebok på hvis du ikke lagrer den. Les [hjelpesiden](www.wallet.etig.europool.me/#help) for ytterligere instruksjoner (foreløpig kun på engelsk). ',
...
TranslatorName_1            : '[mrstormlars](www.wallet.etig.europool.me/?gaslimit=21000&to=mrstormlars.eth&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_Remind_Desc_1          : '**Ethereum, EthereumTiger Wallet & EthereumTiger Wallet CX, og noen av de underliggende Javascript-bibliotekene vi benytter er under aktiv utvikling.** Selv om vi har testet grundig, og titusenvis av lommebøker har blitt opprettet uten feil av folk over hele kloden, så er det alltid en liten mulighet for at noe uventet kan skje som kan medføre at dine ETIG kan tapes. Vennligst ikke invester mer enn du er villig til å tape, and vær så snill å være forsiktig. Hvis noe skulle skje, er vi lei oss for det, men **vi er ikke ansvarlige for eventuelt tapte etere**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet & EthereumTiger Wallet CX er ikke "web wallets" (internettlommebøker). Du oppretter ikke en konto eller gir oss dine ethere for oppbevaring hos oss. Alle data forblir på din PC / i din nettleser. Vi gjør det enkelt for deg å opprette, lagre og få tilgang til din informasjon og samhogle med blokkjeden. ',
...
HELP_1_Desc_1               : 'Gå til "Send EthereumTiger & Tokens"-siden. ',
...
HELP_3_Desc_3               : 'Naviger til EthereumTiger Wallet sin "Vis lommebok-info"-side. ',
...
HELP_4_Desc_2               : 'Naviger til "Send EthereumTiger & Tokens"-siden. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med EthereumTiger Wallet CX (Chrome-utvidelsen)? ',
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send EthereumTiger & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send EthereumTiger & Tokens"-siden ',

HELP_5_Title                : '5) Hvordan kan jeg bruke EthereumTiger Wallet offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke EthereumTiger Wallet på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
...
HELP_5_Desc_9               : 'Siden vi oppdaterer EthereumTiger Wallet hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_7_Desc_1               : 'Naviger til "Send EthereumTiger & Tokens"-siden. ',
...
HELP_8_Desc_2               : 'Hvis EthereumTiger Wallet går ned, må du finne en annen måte (som f.eks. geth eller Ethereum Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av EthereumTiger Wallet, fordi den ikke befinner seg i MyEtherWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
...
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned EthereumTiger Wallet svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',

HELP_8CX_Title              : '8) Hva skjer hvis EthereumTiger Wallet CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med EthereumTiger Wallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med EthereumTiger Wallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis EthereumTiger Wallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',

HELP_9_Title                : '9) Er "Send EthereumTiger & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send EthereumTiger & Tokens". Dette vil kringkaste transaksjonen din. ',

HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med EthereumTiger Wallet til geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Ved å bruke en Geth/Mist JSON-fil fra EthereumTiger Wallet v2+.... ',
...
HELP_16_Desc_1              : 'Du kan bruke en blokkjede-utforsker som [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/). Lim inn adressen i søkefeltet og den vil finne fram adressen og transaksjonshistorikken. For eksempel, her ser du hvordan vår [donasjonskonto](https://explorer.www.wallet.etig.europool.me.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) ser ut på explorer.www.wallet.etig.europool.me.org ',

HELP_17_Title               : '17) Hvorfor vises ikke saldoen min når jeg låser opp lommeboken min? ',
HELP_17_Desc_1              : 'Dette er mest sannsynlig fordi du er bak en brannmur. API-en vi bruker for å innhente saldoen blokkeres ofte av brannmurer av ymse årsaker. Du vil fortsatt være i stand til å sende transaksjoner, du må bare bruke en annen metode for å se nevnte saldo, som explorer.www.wallet.etig.europool.me.org ',
...
HELP_SecCX_Title            : 'Datasikkerhet - EthereumTiger Wallet CX (Chrome-utvidelsen) ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke EthereumTiger Wallet i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send EthereumTiger & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) til domenet: [www.wallet.etig.europool.me](www.wallet.etig.europool.me). ',
