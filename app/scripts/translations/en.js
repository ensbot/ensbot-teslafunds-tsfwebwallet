...
ENS_Helper_4                    :  'Decide the maximum amount of TSF you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 TSF for gas.',
...
EOS_06                          :  'Go to Send Teslafunds & Tokens Page',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to Teslafunds Wallet',
...
ONBOARD_welcome_content__4      :  'What is Teslafunds Wallet? ',
ONBOARD_welcome_content__5      :  'Teslafunds Wallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'Teslafunds Wallet is not a Bank',
...
ONBOARD_interface_title         :  'Teslafunds Wallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on Teslafunds Wallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you TSF or tokens. 👍',
ONBOARD_interface_content__7    :  'If you send your *private key* to someone, they now have full control of your account. 👎',
ONBOARD_bank_title__alt         :  'Teslafunds Wallet isn\'t a Bank',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from Teslafunds Wallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on Teslafunds Wallet or view your transactions on [explorer.www.wallet.TSF.europool.me.org](https://explorer.www.wallet.TSF.europool.me.org), you are seeing data on the blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'Teslafunds Wallet is an Interface',
...
ONBOARD_blockchain_title__alt   :  'WTF is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of Teslafunds Wallet then?',
ONBOARD_whymew_title            :  'If Teslafunds Wallet can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'If you are scared but want to use Teslafunds Wallet, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like Teslafunds Wallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `www.wallet.TSF.europool.me`.',
ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `Teslafunds` in green.',
...
ONBOARD_final_content__3        :  'How to Set up Teslafunds Wallet + MetaMask',
ONBOARD_final_content__4        :  'How to Run Teslafunds Wallet Offline / Locally',
...
/* Old */
ADD_DigitalBitbox_0a            :  'Re-open Teslafunds Wallet on a secure (SSL) connection',
ADD_DigitalBitbox_0b            :  'Re-open Teslafunds Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
ADD_DigitalBitbox_scan          :  'Connect your Digital Bitbox',
ADD_Secalot_0a              : 'Re-open Teslafunds Wallet on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open Teslafunds Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_Ledger_0a                   :  'Please use Teslafunds Wallet on a secure (SSL / HTTPS) connection to connect.',
ADD_Ledger_0b                   :  'Re-open Teslafunds Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
PARITY_AlreadyImported          :  "(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [explorer.www.wallet.TSF.europool.me.org](https://explorer.www.wallet.TSF.europool.me.org) & wait 10 minutes before attempting to send again. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
GAS_LIMIT_Desc                  :  'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending TSF = `21000`. Sending Tokens = ~`200000`.',
...
GEN_Help_12                     :  'Use it to unlock your wallet via Teslafunds Wallet (or Mist, Geth, Parity and other wallet clients.)',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your Teslafunds Wallet CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
NAV_SendEther                   :  'Send Teslafunds & Tokens',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via MyEtherWallet. You can [download the Teslafunds Wallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
sidebar_donation                :  'Teslafunds Wallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different TSF node (e.g. `TSF (Etherscan.io)` or `TSF (Infura.io)` or `TSF (MyEtherWallet)`) and check again.',
...
TXFEE_Desc                      :  'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> TSF here](www.wallet.TSF.europool.me/helpers.html)',

VIEWWALLET_HidePrivKey          :  '(hide)',
VIEWWALLET_ShowPrivKey          :  '(show)',
VIEWWALLET_Subtitle             :  'This allows you to download different versions of private keys and re-print your paper wallet. You may want to do this in order to [import your account into Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). If you want to check your balance, we recommend using a blockchain explorer like [explorer.www.wallet.TSF.europool.me.org](https://explorer.www.wallet.TSF.europool.me.org/#/).',
...
HELP_12_Desc_1                  :  'Using an Geth/Mist JSON file from Teslafunds Wallet v2+....',
...
HELP_12_Title                   :  '12) How do I import a wallet created with Teslafunds Wallet into geth / Ethereum Wallet / Mist?',
...
HELP_14_Desc_1                  :  'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Teslafunds Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_14_Title                   :  '14) Some sites randomize (seed) the private key generation via mouse movements. Teslafunds Wallet doesn\'t do this. Is the random number generation for Teslafunds Wallet safe?',
...
HELP_16_Desc_1                  :  'You can use a blockchain explorer like [explorer.www.wallet.TSF.europool.me.org](https://explorer.www.wallet.TSF.europool.me.org/#/). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://explorer.www.wallet.TSF.europool.me.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on explorer.www.wallet.TSF.europool.me.org',
HELP_16_Title                   :  '16) How do I check the balance of my account?',
HELP_17_Desc_1                  :  'This is most likely due to the fact that you are behind a firewall. The API that we use to get the balance and convert said balance is often blocked by firewalls for whatever reason. You will still be able to send transactions, you just need to use a different mTSFd to see said balance, like explorer.www.wallet.TSF.europool.me.org',
...
HELP_3_Desc_3                   :  'Navigate to the Teslafunds Wallet "View Wallet Info" page.',
...
HELP_4_Desc_2                   :  'Navigate to the "Send Teslafunds & Tokens" page.',
...
HELP_4CX_Desc_1                 :  'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send Teslafunds & Tokens" page.',
HELP_4CX_Desc_10                :  'Enter the password for that wallet.',
HELP_4CX_Desc_11                :  'Click "Send Transaction."',
HELP_4CX_Desc_12                :  'Using "Send Teslafunds & Tokens" Page',
...
HELP_4CX_Title                  :  '4) How do I send Ether using Teslafunds Wallet CX?',
HELP_5_Desc_1                   :  'You can run Teslafunds Wallet on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7                   :  'Teslafunds Wallet is now running entirely on your computer.',
HELP_5_Desc_8                   :  'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the Teslafunds Wallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact.',
HELP_5_Desc_9                   :  'As we are constantly updating Teslafunds Wallet, we recommend you periodically update your saved version of the repo.',
HELP_5_Title                    :  '5) How do I run Teslafunds Wallet offline/locally?',
...
HELP_7_Desc_1                   :  'Navigate to the "Send Teslafunds & Tokens" page.',
...
HELP_8_Desc_1                   :  'Teslafunds Wallet is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain.',
HELP_8_Desc_2                   :  'If Teslafunds Wallet goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of Teslafunds Wallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site.',
...
HELP_8CX_Desc_2                 :  'That said, it is **very important** that you back up all your information for any new wallets generated with Teslafunds Wallet CX. That way if anything happens to Teslafunds Wallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets.',
HELP_8CX_Desc_3                 :  'If for some reason Teslafunds Wallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
HELP_8CX_Title                  :  '8) What happens if Teslafunds Wallet CX disappears?',
...
HELP_9_Title                    :  '9) Is the "Send Teslafunds & Tokens" page offline?',
...
HELP_Remind_Desc_1              :  '**Ethereum, Teslafunds Wallet & Teslafunds Wallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your TSF to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**.',
HELP_Remind_Desc_2              :  'MyEtherWallet & Teslafunds Wallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_Sec_Desc_4                 :  'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [www.wallet.TSF.europool.me](www.wallet.TSF.europool.me).',
...
HELP_SecCX_Desc_6               :  'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Teslafunds Wallet instead of this Chrome Extension.',
HELP_SecCX_Title                :  'Security - Teslafunds Wallet CX',
