...
tx_notFound_4               : 'Użyj menu w prawym górnym rogu aby wybrać inny węzeł ETIG (np. `ETIG (Etherscan.io)` lub `ETIG (Infura.io)` lub `ETIG (MyEtherWallet)`) i sprawdź ponownie.',
...
tx_FoundOnChain_3           : '**Jeśli nie pojawią się żadne komunikaty o błędzie, to Twoja transakcja została pomyślnie wysłana.** Twój ETIG lub Tokeny są tam, gdzie zostały wysłane. Jeśli jednak ETIG lub Tokeny nie pojawią się tam, gdzie zostały wysłane i minęły ponad 24 godziny od momentu wysłania, [skontaktuj się z którymś z serwisów](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Wyślij im *link* do Twojej transakcji i uprzejmie poproś o zbadanie sytuacji.',
...
TRANS_data                  : 'Dane ',
TRANS_sendInfo              : 'Standardowa transakcja, zużywająca 21000 paliwa, będzie kosztować 0.000441 ETH. My używamy ceny paliwa nieco-powyżej-minimum, co odpowiada 0.000000021 ETIG aby upewnić się, że zostanie szybko zatwierdzona. Nie pobieramy żadnych dodatkowych opłat. ',
...
TRANSModal_Content_1        : '**ETIG (Standardowa Transakcja): ** generuje standardową transakcję bezpośrednio z jednego adresu do drugiego. Domyślnie spala 21000 paliwa. Prawdopodobnie transakcja ETIG zostanie powielona na łańcuchu ETC jeżeli posiadasz obie waluty na tym samym adresie. ',
...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim EthereumTiger Wallet CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_0a               : 'Otwórz EthereumTiger Wallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz EthereumTiger Wallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz EthereumTiger Wallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz EthereumTiger Wallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
SWAP_init_2                 : " na ", // "I want to swap my X ETIG for X BTC"
...
SWAP_progress_3             : "Otrzymano! ", // ETIG Received!
...
SWAP_unlock                 : "Odblokuj Twój portfel, aby wysłać ETIG lub Tokeny wprost z tej strony. ",
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](www.wallet.etig.europool.me/#help) po instrukcje. ',
...
HELP_4CX_Title              : '4)Jak wysłać Ether używając EthereumTiger Wallet CX? ',
...
HELP_5_Title                : '5) Jak uruchomić EthereumTiger Wallet offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić EthereumTiger Wallet lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyEtherWallet działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium EthereumTiger Wallet na przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy EthereumTiger Wallet, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_8_Desc_2               : 'Jeżeli EthereumTiger Wallet zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Ethereum Wallet / Mist) na korzystanie z sieci Ethereum. Nie musiałbyś jednak wypłacić swoich środków z EthereumTiger Wallet, ponieważ one nie znajdują się na EthereumTiger Wallet, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
...
HELP_8_Desc_4               : 'W dodatku prawdopodobieństwo zamknięcia przez nas strony EthereumTiger Wallet jest bliskie zeru. Koszty utrzymania strony są prawie żadne, ponieważ nie przechowujmy żadnych informacji. Jeśli nawet strona zostanie zamknięta, jest ona również i zawsze będzie publicznie dostępna na [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Możesz ściągnąć paczkę ZIP i uruchomić EthereumTiger Wallet lokalnie na własnym komputerze. ',

HELP_8CX_Title              : '8) Co się stanie jeżeli EthereumTiger Wallet CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą EthereumTiger Wallet CX. W ten sposób, jeżeli cokolwiek stanie się EthereumTiger Wallet CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu EthereumTiger Wallet CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w EthereumTiger Wallet do geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z EthereumTiger Wallet v2+.... ',
...
HELP_16_Desc_1              : 'Możesz użyć eksploratora bloków jak [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/). Wklej swój adres w wyszukiwarkę na stronie eksploratora, pokaże ona stan Twojego konta oraz historię transakcji. Tak na przykład wygląda nasze [konto donacji](https://explorer.www.wallet.etig.europool.me.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) na explorer.www.wallet.etig.europool.me.org. ',

HELP_17_Title               : '17) Dlaczeg stan mojego konta nie pojawia się, kiedy odblokowuje mój portfel? ',
HELP_17_Desc_1              : 'Najprawdopodobniej przyczyną tego jest firewall. API, które używamy do odczytu stanu konta oraz jego konwersji jest często blokowane przez firewall z różnych przyczyn. Wciąż możesz wysyłać transakcje, jednak stan konta musisz sprawdzać w inny sposób, np. na [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/) ',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - EthereumTiger Wallet CX ',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Strona jest dostępna pod domenami: [www.wallet.etig.europool.me](www.wallet.etig.europool.me). ',
