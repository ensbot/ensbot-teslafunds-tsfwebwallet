...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETIG différent (par ex. `ETIG (Etherscan.io)`, `ETIG (Infura.io)` ou `ETIG (MyEtherWallet)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec EthereumTiger Wallet (ou Mist, Geth, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETIG ici.](www.wallet.etig.europool.me/helpers.html)',
...
TRANS_warning               : 'L\'emploi des fonctions "ETIG seulement" et "ETC seulement" vous fait passer par un contrat. Certains services ont des problèmes avec ces transactions. En savoir plus.',
...
TRANSModal_Title            : 'Transactions "ETIG seulement" et "ETC seulement"',
TRANSModal_Content_0        : 'Note sur les transactions et services divers :',
TRANSModal_Content_1        : '**ETIG (Transaction standard) :** Génère une transaction standard depuis une adresse directement vers une autre. Son GAS par défaut est de 21000. Il est probable que toute transaction d\'ETIG envoyée de cette manière sera réexécutée sur la chaîne ETC.',
TRANSModal_Content_2        : '**ETIG seulement :** Envoi à travers le [contrat anti-réexécution de Timon Rapp (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **ETH**.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec EthereumTiger Wallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et d\'imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth / Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez seulement consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/).',
...
ADD_Ledger_0a               : 'Rouvrir EthereumTiger Wallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir EthereumTiger Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir EthereumTiger Wallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir EthereumTiger Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
SWAP_init_2                 : " contre", // "I want to swap my X ETIG for X BTC"
...
SWAP_progress_3             : "reçu !", // ETIG Received!
...
SWAP_unlock                 : "Déverrouillez votre portefeuille pour envoyer des ETIG ou des tokens directement depuis cette page.",
...
TranslatorName_1            : '[Simon P](www.wallet.etig.europool.me/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec EthereumTiger Wallet ?',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec EthereumTiger Wallet CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer EthereumTiger Wallet hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer EthereumTiger Wallet sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'MyEtherWallet tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo EthereumTiger Wallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment EthereumTiger Wallet, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_2               : 'Si EthereumTiger Wallet venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis EthereumTiger Wallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par EthereumTiger Wallet CX. De cette manière, si quoi que ce soit arrivait à EthereumTiger Wallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, EthereumTiger Wallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par EthereumTiger Wallet dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de EthereumTiger Wallet v2+.... ',
...
HELP_16_Desc_1              : 'Vous pouvez utiliser un explorateur de blockchain comme [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/). Collez votre adresse dans la barre de recherche et cela récupérera votre solde et l\'historique de vos transactions. Par exemple, voici ce que montre notre [compte de donations](https://explorer.www.wallet.etig.europool.me.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) sur explorer.www.wallet.etig.europool.me.org',

HELP_17_Title               : '17) Pourquoi mon solde n\'apparaît-il pas quand je déverrouille mon portefeuille ?',
HELP_17_Desc_1              : 'C\'est probablement dû au fait que vous vous trouviez derrière un parefeu. L\'API que nous utilisons pour obtenir le solde et converir celui-ci est souvent bloquée par des parefeus pour des raisons diverses. Vous êtes toujours capable d\'envoyer des transactions mais il vous faut employer une autre méthode pour voir le solde, comme explorer.www.wallet.etig.europool.me.org',
...
HELP_SecCX_Title            : 'Sécurité - EthereumTiger Wallet CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser EthereumTiger Wallet au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [www.wallet.etig.europool.me](www.wallet.etig.europool.me).',
