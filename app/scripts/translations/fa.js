...
ENS_Helper_4                    :  'Decide the maximum amount of ETIG you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 ETIG for gas.',
...
EOS_06                          :  'Go to Send EthereumTiger & Tokens Page',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to EthereumTiger Wallet',
...
ONBOARD_welcome_content__4      :  'What is EthereumTiger Wallet? ',
ONBOARD_welcome_content__5      :  'EthereumTiger Wallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'EthereumTiger Wallet is not a Bank',
...
ONBOARD_interface_title         :  'EthereumTiger Wallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on EthereumTiger Wallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you ETIG or tokens. 👍',
ONBOARD_interface_content__7    :  'If you send your *private key* to someone, they now have full control of your account. 👎',
ONBOARD_bank_title__alt         :  'EthereumTiger Wallet isn\'t a Bank',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from EthereumTiger Wallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on EthereumTiger Wallet or view your transactions on [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org), you are seeing data on the blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'EthereumTiger Wallet is an Interface',
...
ONBOARD_blockchain_title__alt   :  'WTF is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of EthereumTiger Wallet then?',
ONBOARD_whymew_title            :  'If EthereumTiger Wallet can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'If you are scared but want to use EthereumTiger Wallet, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like EthereumTiger Wallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `www.wallet.etig.europool.me`.',
ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `EthereumTiger` in green.',
...
ONBOARD_final_content__3        :  'How to Set up EthereumTiger Wallet + MetaMask',
ONBOARD_final_content__4        :  'How to Run EthereumTiger Wallet Offline / Locally',
...
sidebar_donation: 'وبسایت EthereumTiger Wallet یک سرویس متن باز و رایگان است که وقف امنیت و حریم خصوصی شما شده است. هرچه مقدار کمک های مالی بیشتر باشد، می توانیم زمان بیشتری برای ایجاد ویژگی های جدید، خواندن نظرات شما و ارائه محصولاتی که می خواهید داشته باشیم. ما تنها دو نفر هستیم که سعی در تغییر جهان داریم. کمک می کنید؟ ',
...
ADD_Ledger_0a: 'با یک کانکشن امن (SSL) دوباره EthereumTiger Wallet را باز کنید. ',
ADD_Ledger_0b: 'با استفاده از [Chrome](https://www.google.com/chrome/browser/desktop/) یا [Opera](https://www.opera.com/) دوباره EthereumTiger Wallet را باز کنید. ',
...
MYWAL_Content_3: ',اگر در آینده بخواهید از این کیف پول با استفاده از  EthereumTiger Wallet CX خود استفاده کنید، باید بصورت دستی دوباره آن را اضافه کنید. این کار با استفاده از key/JASON و رمزعبور انجام می شود.',
...
SWAP_init_2: ' for , // ""I want to swap my X ETIG for X BTC',
SWAP_init_CTA: 'ادامه ',
...
SWAP_progress_3: 'Received! , // ETIG Received!',
SWAP_progress_4: 'Sending your {{orderResult.output.currency}} ,',
SWAP_progress_5: 'Order Complete ,',
SWAP_order_CTA: 'Please send , // Please send 1 ETH...',
SWAP_unlock: 'Unlock your wallet to send ETIG or Tokens directly from this page. ',
...
ERROR_27                        :  '(error_28) برای دسترسی به این کیف پول در آینده به فایل Keystore و رمزعبور خود (یا کلید خصوصی) نیاز خواهید داشت. لطفا آن را ذخیره کنید و یک نسخه پشتیبان خارجی بسازید. اگر آن را ذخیره نکنید، هیچ راهی برای بازگرداندن کیف پول وجود ندارد. برای راهنمایی [صفحه کمک](www.wallet.etig.europool.me/#help)  را مطالعه بفرمایید. Minimum amount: 0.01. Max amount:', // 27
...
HELP_4CX_Title: 'سوال 4: چگونه با کیف پول EthereumTiger Wallet خود اتر ارسال کنم؟ ',
...
HELP_5_Title: 'سوال 5: چگونه از EthereumTiger Wallet بصورت آفلاین استفاده کنم؟ ',
HELP_5_Desc_1: 'شما می توانید EthereumTiger Wallet را به جای اجرا از روی سرورهای GitHub، روی کامپیوتر خود اجرا کنید. شما می توانید یک کیف پول را کاملا بصورت آفلاین بسازید و تراکنشی را از طریق صفحه ""تراکنش آفلاین"" ارسال کنید. ',
HELP_5_Desc_7: 'حال EthereumTiger Wallet بطور کامل در حال اجرا شدن از روی کامپیوتر شماست. ',
HELP_5_Desc_8: 'در صورتی که با این موضوع آشنایی ندارید بهتر است بدانید که باید تمام پوشه (فولدر) را نگهداری کنید تا بتوانید وبسایت را اجرا کنید (نه فقط index.html را). به چیزی در این پوشه دست نزنید و یا جابجا نکنید. اگر یک نسخه پشتیبان از کد مخزن EthereumTiger Wallet را برای آینده نگهداری می کنید پیشنهاد می شود که تنها ZIP را نگهداری کنید تا از اینکه تمام محتوای پوشه درست ذخیره می شوند اطمینان حاصل کنید. ',
HELP_5_Desc_9: 'از آنجایی که ما بطور مداوم در حال بروزرسانی EthereumTiger Wallet هستیم، پیشنهاد می کنیم که نسخه ذخیره شده خود را بصورت دوره ای بروزرسانی کنید. ',
...
HELP_8_Desc_1: 'وبسایت EthereumTiger Wallet یک کیف پول وبی نیست. نیازی نیست که وارد شوید (لاگین کنید) و هیچ چیزی بر روی سرورهای ما ذخیره نمی شود. این تنها یک ظاهر است که به شما امکان برقراری ارتباط با بلاکچین را می دهد. ',
HELP_8_Desc_2: 'اگر  EthereumTiger Wallet از کار بیافتد، راه دیگری (مثل geth یا Ethereum Wallet/ Mist) وجود دارد که کاری که ما انجام می دهیم را انجام دهد. اما نیازی نیست که اترهای خود را از  EthereumTiger Wallet بیرون بیاورید چرا که آن ها در  EthereumTiger Wallet نیستند، بلکه در هر کیف پولی ست که شما از طریق سایت ما ساخته باشید. ',
...
HELP_8CX_Desc_2: 'مهم است در نظر داشته باشید که برای هر کیف پولی که با  EthereumTiger Wallet CX ساخته می شود، از تمام اطلاعات خود یک نسخه پشتیبان تهیه کنید. در اینصورت اگر هر اتفاقی برای  EthereumTiger Wallet CX یا کامپیوترتان بیافتد، همچنان اطلاعات لازم جهت دسترسی به اترهای خود را خواهید داشت. به سوال 2 الف برای چگونگی تهیه نسخه پشتیبان از کیف پول مراجعه کنید. ',
HELP_8CX_Desc_3: 'اگر به هر دلیلی  EthereumTiger Wallet CX از Chrome Store ناپدید شد، می توانید سورس (کد منبع) آن را از Github پیدا کرده و بصورت دستی اجرا کنید. به سوال شماره 5 مراجعه کنید. ',
...
HELP_12_Title: 'سوال 12: چگونه کیف پولی که با EthereumTiger Wallet ساخته ام را به geth یا Ethereum Wallet یا Mist منتقل کنم؟ ',
HELP_12_Desc_1: ',با استفاده از فایل Geth یا Mist JSON از EthereumTiger Wallet نسخه 2 به بالا.',
...
HELP_14_Title: 'سوال 14: برخی از سایت ها ساخت رندوم یا تصادفی کلیدهای خصوصی را بر اساس حرکت موس انجام می دهند. سایت EthereumTiger Wallet این کار را انجام نمی دهد. آیا تولید تصادفی اعداد برای EthereumTiger Wallet امن است؟ ',
HELP_14_Desc_1: 'روش ساخت بر اساس حرکت موس هوشمندانه است و می دانیم که  چرا مردم آن را دوست دارند، اما واقعیت این است که window.crypto ؟؟؟؟؟ بیشتری را نسبت به حرکات موس شما ارائه می کنند. حرکات موس ناامن نیستند اما ما (و بسیاری از آزمایش های کریپتو دیگر) در window.crypto باور بیشتری داریم. بعلاوه اینکه از EthereumTiger Wallet می توان در دستگاه های لمسی نیز استفاده کرد. در [اینجا می توانید بحث بین یک نویسنده عصبانی در reddit و Vitalik Buterin درباره حرکات موس و window.crypto را ببینید](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1: 'برای این کار می توانید از یک مرورگر بلاکچین مثل  [explorer.www.wallet.etig.europool.me.org](https://explorer.www.wallet.etig.europool.me.org/#/) استفاده کنید. آدرس خود را در قسمت search (جستجو) وارد کنید و بعد می توانید آدرس و سابقه تراکنش های خود را مشاهده کنید. برای مثال حساب اهدایی ما [بدین صورت](https://explorer.www.wallet.etig.europool.me.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) است. ',

HELP_17_Title: 'سوال 17: چرا زمانی که قفل کیف پول خود را باز می کنم موجودی من نمایش داده نمی شود؟ ',
HELP_17_Desc_1: 'این موضوع احتمالا بخاطر این است که شما پشت یک firewall (دیوار آتشین) هستید. API که ما برای بدست آوردن موجودی استفاده می کنیم به دلایلی معمولا توسط فایر وال ها بلاک می شوند. شما همچنان می توانید تراکنش هایتان را ارسال کنید و برای دیدن موجودی خود تنها باید از راه دیگری (مثل explorer.www.wallet.etig.europool.me.org) استفاده کنید. ',
...
HELP_SecCX_Title: 'امنیت - EthereumTiger Wallet CX ',
...
HELP_SecCX_Desc_6: 'اگر می خواستیم این موارد را رمزنگاری کنیم، هربار که می خواستید موجودی حساب یا نام های اختصاری را ببینید مجبور به وارد کردن رمزعبور می شدید. اگر این موضوع برایتان مهم است، پیشنهاد می کنیم از EthereumTiger Wallet به جای این Chrome Extension استفاده کنید. ',
...
HELP_Sec_Desc_4: 'این سایت از طریق GitHub ارائه می شود، می توانید کد اصلی یا Source Code آن را در این آدرس ببینید:  [https://github.com/kvhnuke/etherwallet/tree/gh-](https://github.com/kvhnuke/etherwallet/tree/gh-pages) و [www.wallet.etig.europool.me](www.wallet.etig.europool.me). ',
