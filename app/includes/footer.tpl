<section class="pre-footer">
  <div class="container">
    <p>
      Teslafunds does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer ng-scope" role="content" aria-label="footer" ng-controller="footerCtrl">
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <p>
        <span>
          Free, open-source, client-side interface for generating Teslafunds wallets.
        </span>
      </p>
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="twitter" title="twitter" href="https://github.com/teslafunds" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/teslafunds" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
